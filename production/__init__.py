...
All UTC hours (no session gate). No TP / no short time-exit (horizon = research CAP 48).
"""
...
# Primary density (live rolling percentile gate). Research ~1000 trades/year on H1.
PRIMARY_TOP_PCT: float = 0.21
...
# Daily 1R armed only while equity <= this; above it = daily OFF. None = always ON.
DAILY_ON_EQUITY_MAX: float | None = 80.0

# --- Sizing: fixed 0.01 lot (ATR map kept for restore; currently off) ---
